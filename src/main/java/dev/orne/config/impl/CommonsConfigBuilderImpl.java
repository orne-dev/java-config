...
implements CommonsConfigBuilder {
     ...
     */
    @Override
    public CommonsConfigBuilder ofDelegate(
            final ImmutableConfiguration delegate) {
     ...
     */
    @Override
    public CommonsMutableConfigBuilderImpl mutable() {
     ...
     */
    @Override
    public CommonsConfigImpl build() {
