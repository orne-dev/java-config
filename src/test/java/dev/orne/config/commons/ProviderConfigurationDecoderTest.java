...
/**
 * Unit tests for {@code ProviderConfigurationDecoder}.
 * 
 * @author <a href="mailto:wamphiry@orne.dev">(w) Iker Hernaez</a>
 * @version 1.0
 * @since 0.2
 * @see ProviderConfigurationDecoder
 */
@Tag("ut")
class ProviderConfigurationDecoderTest {

    /**
     * Test method for {@link ProviderConfigurationDecoder#ProviderConfigurationDecoder(ConfigCryptoProvider)}.
     */
    @Test
    void testConstructor() {
        final ConfigCryptoProvider provider = mock(ConfigCryptoProvider.class);
        final ProviderConfigurationDecoder decoder = new ProviderConfigurationDecoder(provider);
    ...
    void testConstructorNull() {
        assertThrows(NullPointerException.class, () -> {
            new ProviderConfigurationDecoder(null);
        });
    }

    /**
     * Test method for {@link ProviderConfigurationDecoder#decode(String)}.
     */
    @Test
    void testDecode()
