...
/**
 * Unit tests for {@link YamlMutableConfig}.
 * 
...
extends AbstractWatchableConfigTest {
    ...
    void testEmptyBuilder() {
        final YamlMutableConfig config = Config.fromYamlFiles()
                .mutable()
                .build();
    ...
    /**
     * Test method for {@link YamlMutableConfig#YamlMutableConfig(ConfigOptions, MutableConfigOptions, YamlConfigOptions)}.
     */
    @Test
    void testOptionsConstructor() {
        ...
        given(yamlOptions.getJsonObject()).willReturn(mockJsonObject);
        given(yamlOptions.getPropertySeparator()).willReturn(mockSeparator);
        
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(null, null, null);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(null, mutableOptions, yamlOptions);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(baseOptions, null, yamlOptions);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(baseOptions, mutableOptions, null);
        });
        
        final YamlMutableConfig config = new YamlMutableConfig(
                baseOptions,
                mutableOptions,
                yamlOptions);
    ...
    void testComponentsConstructor() {
        final String mockSeparator = "mock.separator";
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(null, null, null, null, null, null);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(mockParent, null, mockEncoder, mockDecorator, mockJsonObject, mockSeparator);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(mockParent, mockDecoder, null, mockDecorator, mockJsonObject, mockSeparator);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(mockParent, mockDecoder, mockEncoder, null, mockJsonObject, mockSeparator);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(mockParent, mockDecoder, mockEncoder, mockDecorator, null, mockSeparator);
        });
        assertThrows(NullPointerException.class, () -> {
            new YamlMutableConfig(null, mockDecoder, mockEncoder, mockDecorator, mockJsonObject, null);
        });
        assertDoesNotThrow(() -> {
            new YamlMutableConfig(null, mockDecoder, mockEncoder, mockDecorator, mockJsonObject, mockSeparator);
        });
