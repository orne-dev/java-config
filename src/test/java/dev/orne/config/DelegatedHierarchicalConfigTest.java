...
/**
 * Unit tests for {@code DelegatedHierarchicalConfig}.
 * 
 ...
 */
@Tag("ut")
class DelegatedHierarchicalConfigTest {

    private static final String TEST_KEY = "test.key";

    /**
     * Test method for {@link DelegatedHierarchicalConfig#DelegatedHierarchicalConfig(Config, Config)}.
     */
    @Test
    void testConstructor() {
        final Config delegated = mock(Config.class);
        final Config parent = mock(Config.class);
        final DelegatedHierarchicalConfig config =
                new DelegatedHierarchicalConfig(delegated, parent);
    ...
    void testConstructor_NullParent() {
        final Config delegated = mock(Config.class);
        final DelegatedHierarchicalConfig config =
                new DelegatedHierarchicalConfig(delegated, null);
        assertSame(delegated, config.getDelegate());
    ...
    void testConstructor_NullDelegated() {
        ...
        assertThrows(NullPointerException.class, () -> {
            new DelegatedHierarchicalConfig(null, parent);
        });
    }
    ...
    void testConstructor_Nulls() {
        assertThrows(NullPointerException.class, () -> {
            new DelegatedHierarchicalConfig(null, null);
        });
    }

    /**
     * Test method for {@link DelegatedHierarchicalConfig#contains(String)}.
    ...
    /**
     * Test method for {@link DelegatedHierarchicalConfig#get(String, Class)}.
     * @throws ConfigException Shouldn't happen
     */
    @ParameterizedTest
    @ValueSource(ints = {0, 1, 2, 3})
    ...
    /**
     * Test method for {@link DelegatedHierarchicalConfig#getBoolean(String)}.
     * @throws ConfigException Shouldn't happen
     */
    @ParameterizedTest
    @ValueSource(ints = {0, 1, 2, 3})
    ...
    /**
     * Test method for {@link DelegatedHierarchicalConfig#getNumber(String)}.
     * @throws ConfigException Shouldn't happen
     */
    @ParameterizedTest
    @ValueSource(ints = {0, 1, 2, 3})
    ...
    /**
     * Test method for {@link DelegatedHierarchicalConfig#getString(String)}.
     * @throws ConfigException Shouldn't happen
     */
    @ParameterizedTest
    @ValueSource(ints = {0, 1, 2, 3})
